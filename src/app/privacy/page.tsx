...
export const metadata: Metadata = {
  title: "Privacy Policy | TRIAD",
  description: "TRIAD Privacy Policy",
};

export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 pt-24 pb-16 text-neutral-200">
      <h1 className="text-3xl font-semibold mb-4">Privacy Policy</h1>
      <p className="mb-6 text-sm text-neutral-400">Last updated: October 07, 2025</p>
      ...
      <div className="space-y-4 leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold pt-6">Interpretation and Definitions</h2>
        <h3 className="text-xl font-semibold pt-4">Interpretation</h3>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Triad, accessible from
              {" "}
              <a
                href="https://triad-community.org"
                rel="external nofollow noopener noreferrer"
                target="_blank"
                className="underline hover:text-white"
              >
                https://triad-community.org
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-2xl font-semibold pt-6">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl font-semibold pt-4">Types of Data Collected</h3>
        <h4 className="text-lg font-semibold pt-3">Personal Data</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold pt-3">Usage Data</h4>
        ...
        <h4 className="text-lg font-semibold pt-3">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="text-xl font-semibold pt-4">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold pt-4">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold pt-4">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold pt-4">Delete Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold pt-4">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg font-semibold pt-3">Business Transactions</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold pt-3">Law enforcement</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold pt-3">Other legal requirements</h4>
        ...
        <h3 className="text-xl font-semibold pt-4">Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className="text-2xl font-semibold pt-6">Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold pt-6">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold pt-6">Changes to this Privacy Policy</h2>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>By email: triads.community@gmail.com</li>
        </ul>
      </div>
    </main>
  );
